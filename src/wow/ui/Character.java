...
public class Character extends WoWscreen {
	...
	System.err.println("Character.activate() active="+active);
    }

    public void sizeEvent(int width, int height) {
	System.err.println("Character.sizeEvent() "+width+" x "+height);
	m_width = width;
	m_buttonY = height - 18;
	int n = (width-2) / 34;
	...
	m_buttonCount = n;
	WoWgame.self().setDebug("Character buttons: "+n);
    }
	...
	System.err.println("Character.keyEvent() key="+key+" act="+action+" press="+pressed);
