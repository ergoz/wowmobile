...
public class Talents extends WoWscreen {
	...
	System.err.println("Talents.activate() active="+active);
	if (active)
	...
	System.err.println("Talents.sizeEvent() "+width+" x "+height);
	m_width = width;
	m_buttonY = height - 18;
	int n = (width-2) / 34;
	...
	m_buttonCount = n;
	WoWgame.self().setDebug("Talents buttons: "+n);
    }
	...
	System.err.println("Talents.keyEvent() key="+key+" act="+action+" press="+pressed);
