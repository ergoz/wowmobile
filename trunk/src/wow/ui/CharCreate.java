...
public class CharCreate extends WoWscreen {
	...
	System.err.println("CharCreate.activate() active="+active);
    }

    public void sizeEvent(int width, int height) {
	System.err.println("CharCreate.sizeEvent() "+width+" x "+height);
	m_width = width;
	m_buttonY = height - 18;
	int n = (width-2) / 34;
	...
	m_buttonCount = n;
	WoWgame.self().setDebug("CharCreate buttons: "+n);
    }
	...
	System.err.println("CharCreate.keyEvent() key="+key+" act="+action+" press="+pressed);
